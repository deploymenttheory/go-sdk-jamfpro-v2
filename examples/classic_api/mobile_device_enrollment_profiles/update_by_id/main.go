...
func main() {
	...
	profileID := 1 // Replace with the desired profile ID
	...
	updated, _, err := jamfClient.ClassicAPI.MobileDeviceEnrollmentProfiles.UpdateByID(context.Background(), profileID, updateReq)
	if err != nil {
		fmt.Printf("Error: %v\n", err)
		return
	}
