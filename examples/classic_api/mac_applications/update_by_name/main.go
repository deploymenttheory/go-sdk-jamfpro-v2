...
func main() {
	...
	appName := "Sample Mac App" // Replace with the desired Mac application name to update
	...
	updated, _, err := jamfClient.ClassicAPI.MacApplications.UpdateByName(context.Background(), appName, updateReq)
	if err != nil {
		fmt.Printf("Error: %v\n", err)
		return
	}
