...
func main() {
	...
	// Example usage of UpdateByID — replace with the desired network segment ID and updated request
	segmentID := 1
	...
	updatedSegment, _, err := jamfClient.NetworkSegments.UpdateByID(context.Background(), segmentID, updateReq)
	if err != nil {
