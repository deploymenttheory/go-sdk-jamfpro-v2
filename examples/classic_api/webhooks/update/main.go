...
func main() {
	...
	// Example usage of UpdateByID — replace with the desired webhook ID and updated request
	webhookID := 1
	...
	updatedWebhook, _, err := jamfClient.Webhooks.UpdateByID(context.Background(), webhookID, updateReq)
	if err != nil {
