...
func main() {
	...
	updated, resp, err := client.ClassicAPI.RestrictedSoftware.UpdateByID(ctx, created.ID, updateReq)
	if err != nil {
		_, _ = client.ClassicAPI.RestrictedSoftware.DeleteByID(ctx, created.ID)
