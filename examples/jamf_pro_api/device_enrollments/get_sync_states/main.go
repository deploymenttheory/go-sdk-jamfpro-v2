...
func main() {
	...
	syncStates, resp, err := jamfClient.JamfProAPI.DeviceEnrollments.GetSyncStatesV1(ctx, enrollmentID)
	if err != nil {
	...
	latestSync, latestResp, err := jamfClient.JamfProAPI.DeviceEnrollments.GetLatestSyncStateV1(ctx, enrollmentID)
	if err != nil {
