// Package main demonstrates DownloadScriptByID — downloads a script's contents as plain text.
//
...
func main() {
	...
	data, resp, err := client.Scripts.DownloadScriptByID(ctx, id)
	if err != nil {
		log.Fatalf("DownloadScriptByID failed: %v", err)
	}
