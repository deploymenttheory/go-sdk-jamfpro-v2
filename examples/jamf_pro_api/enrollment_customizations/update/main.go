...
func main() {
	...
	existing, _, err := client.JamfProAPI.EnrollmentCustomizations.GetByIDV2(ctx, customizationID)
	if err != nil {
	...
	updated, resp, err := client.JamfProAPI.EnrollmentCustomizations.UpdateByIDV2(ctx, customizationID, existing)
	if err != nil {
