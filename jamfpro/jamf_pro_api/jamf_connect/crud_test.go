...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/jamf_connect/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*JamfConnect, *mocks.JamfConnectMock) {
	t.Helper()
	mock := mocks.NewJamfConnectMock()
	return NewJamfConnect(mock), mock
}
