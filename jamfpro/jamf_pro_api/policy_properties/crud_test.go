...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/policy_properties/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*PolicyProperties, *mocks.PolicyPropertiesMock) {
	t.Helper()
	mock := mocks.NewPolicyPropertiesMock()
	return NewPolicyProperties(mock), mock
}
