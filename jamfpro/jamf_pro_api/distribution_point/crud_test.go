...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/distribution_point/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*DistributionPoint, *mocks.DistributionPointMock) {
	t.Helper()
	...
	mock.RegisterMocks()
	return NewDistributionPoint(mock), mock
}
