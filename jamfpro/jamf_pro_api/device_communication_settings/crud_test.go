...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/device_communication_settings/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*DeviceCommunicationSettings, *mocks.DeviceCommunicationSettingsMock) {
	t.Helper()
	mock := mocks.NewDeviceCommunicationSettingsMock()
	return NewDeviceCommunicationSettings(mock), mock
}
...
func TestUnit_DeviceCommunicationSettings_NewService(t *testing.T) {
	mock := mocks.NewDeviceCommunicationSettingsMock()
	svc := NewDeviceCommunicationSettings(mock)
