...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/oauth2_session_tokens/mocks"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*Oauth2SessionTokens, *mocks.OAuth2SessionTokensMock) {
	t.Helper()
	mock := mocks.NewOAuth2SessionTokensMock()
	mock.RegisterMocks()
	return NewOauth2SessionTokens(mock), mock
}
