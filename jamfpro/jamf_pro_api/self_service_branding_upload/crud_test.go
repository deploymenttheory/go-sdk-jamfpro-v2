...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/self_service_branding_upload/mocks"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*SelfServiceBrandingUpload, *mocks.SelfServiceBrandingUploadMock) {
	t.Helper()
	mock := mocks.NewSelfServiceBrandingUploadMock()
	mock.RegisterUploadMock()
	return NewSelfServiceBrandingUpload(mock), mock
}
...
func TestUnit_SelfServiceBrandingUpload_Upload_Error(t *testing.T) {
	mock := mocks.NewSelfServiceBrandingUploadMock()
	svc := NewSelfServiceBrandingUpload(mock)
