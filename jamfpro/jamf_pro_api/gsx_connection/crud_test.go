...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/gsx_connection/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*GsxConnection, *mocks.GSXConnectionMock) {
	t.Helper()
	mock := mocks.NewGSXConnectionMock()
	return NewGsxConnection(mock), mock
}
