...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/onboarding/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*Onboarding, *mocks.OnboardingMock) {
	t.Helper()
	mock := mocks.NewOnboardingMock()
	return NewOnboarding(mock), mock
}
