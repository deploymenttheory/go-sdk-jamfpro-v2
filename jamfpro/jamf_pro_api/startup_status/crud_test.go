...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/startup_status/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*StartupStatus, *mocks.StartupStatusMock) {
	t.Helper()
	mock := mocks.NewStartupStatusMock()
	return NewStartupStatus(mock), mock
}
...
func TestUnit_StartupStatus_GetV1_Error_NoMockRegistered(t *testing.T) {
	svc, mock := setupMockService(t)
	mock.RegisterGetStartupStatusErrorMock()
