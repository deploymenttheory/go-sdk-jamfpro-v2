...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/categories/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

// setupMockService creates a Service wired to a fresh CategoriesMock.
func setupMockService(t *testing.T) (*Categories, *mocks.CategoriesMock) {
	t.Helper()
	mock := mocks.NewCategoriesMock()
	return NewCategories(mock), mock
}
