...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/api_roles/mocks"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*ApiRoles, *mocks.APIRolesMock) {
	t.Helper()
	mock := mocks.NewAPIRolesMock()
	mock.RegisterMocks()
	return NewApiRoles(mock), mock
}
...
func TestUnit_ApiRoles_ListV1_Error(t *testing.T) {
	svc := NewApiRoles(mocks.NewAPIRolesMock())
