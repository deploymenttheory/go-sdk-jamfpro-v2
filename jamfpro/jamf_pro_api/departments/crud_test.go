...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/departments/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*Departments, *mocks.DepartmentsMock) {
	t.Helper()
	mock := mocks.NewDepartmentsMock()
	return NewDepartments(mock), mock
}
