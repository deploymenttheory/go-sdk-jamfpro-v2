...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/impact_alert_notification_settings/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*ImpactAlertNotificationSettings, *mocks.ImpactAlertNotificationSettingsMock) {
	t.Helper()
	mock := mocks.NewImpactAlertNotificationSettingsMock()
	return NewImpactAlertNotificationSettings(mock), mock
}
