...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/jamf_management_framework/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*JamfManagementFramework, *mocks.JamfManagementFrameworkMock) {
	t.Helper()
	mock := mocks.NewJamfManagementFrameworkMock()
	return NewJamfManagementFramework(mock), mock
}

func TestUnit_JamfManagementFramework_NewService(t *testing.T) {
	mock := mocks.NewJamfManagementFrameworkMock()
	svc := NewJamfManagementFramework(mock)
