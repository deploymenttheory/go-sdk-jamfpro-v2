...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/smart_mobile_device_groups/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*SmartMobileDeviceGroups, *mocks.SmartMobileDeviceGroupsMock) {
	t.Helper()
	mock := mocks.NewSmartMobileDeviceGroupsMock()
	return NewSmartMobileDeviceGroups(mock), mock
}
