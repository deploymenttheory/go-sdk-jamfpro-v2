...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/computer_groups/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*ComputerGroups, *mocks.ComputerGroupsMock) {
	t.Helper()
	mock := mocks.NewComputerGroupsMock()
	return NewComputerGroups(mock), mock
}
