...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/service_discovery_enrollment/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*ServiceDiscoveryEnrollment, *mocks.ServiceDiscoveryEnrollmentMock) {
	t.Helper()
	mock := mocks.NewServiceDiscoveryEnrollmentMock()
	return NewServiceDiscoveryEnrollment(mock), mock
}
