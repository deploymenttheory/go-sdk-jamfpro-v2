...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/jamf_account_preferences/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*JamfAccountPreferences, *mocks.JamfAccountPreferencesMock) {
	t.Helper()
	mock := mocks.NewJamfAccountPreferencesMock()
	return NewJamfAccountPreferences(mock), mock
}

func TestUnit_JamfAccountPreferences_NewService(t *testing.T) {
	mock := mocks.NewJamfAccountPreferencesMock()
	svc := NewJamfAccountPreferences(mock)
