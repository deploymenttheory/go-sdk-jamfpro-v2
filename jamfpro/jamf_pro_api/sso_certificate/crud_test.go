...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/sso_certificate/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*SsoCertificate, *mocks.SsoCertificateMock) {
	t.Helper()
	mock := mocks.NewSsoCertificateMock()
	return NewSsoCertificate(mock), mock
}
