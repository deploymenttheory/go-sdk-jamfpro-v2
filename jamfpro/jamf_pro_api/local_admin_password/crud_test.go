...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/local_admin_password/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*LocalAdminPassword, *mocks.LocalAdminPasswordMock) {
	t.Helper()
	mock := mocks.NewLocalAdminPasswordMock()
	return NewLocalAdminPassword(mock), mock
}
