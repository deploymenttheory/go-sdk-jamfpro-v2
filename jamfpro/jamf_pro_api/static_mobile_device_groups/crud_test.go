...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/static_mobile_device_groups/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*StaticMobileDeviceGroups, *mocks.StaticMobileDeviceGroupsMock) {
	t.Helper()
	mock := mocks.NewStaticMobileDeviceGroupsMock()
	return NewStaticMobileDeviceGroups(mock), mock
}
