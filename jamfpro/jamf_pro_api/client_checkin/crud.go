...
func NewClientCheckin(client client.Client) *ClientCheckin {
...
func (s *ClientCheckin) AddHistoryNoteV3(ctx context.Context, request *RequestClientCheckinHistoryNote) (*CreateHistoryResponse, *resty.Response, error) {
	if request == nil {
...
func (s *ClientCheckin) UpdateV3(ctx context.Context, request *ResourceClientCheckinSettings) (*ResourceClientCheckinSettings, *resty.Response, error) {
	if request == nil {
		return nil, nil, fmt.Errorf("request is required")
	}
