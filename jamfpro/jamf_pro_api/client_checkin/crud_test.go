...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/client_checkin/mocks"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*ClientCheckin, *mocks.ClientCheckinMock) {
	t.Helper()
	mock := mocks.NewClientCheckinMock()
	mock.RegisterMocks()
	return NewClientCheckin(mock), mock
}
