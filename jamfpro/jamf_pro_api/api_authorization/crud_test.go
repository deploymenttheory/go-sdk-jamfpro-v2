...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/api_authorization/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*ApiAuthorization, *mocks.ApiAuthorizationMock) {
	t.Helper()
	mock := mocks.NewApiAuthorizationMock()
	return NewApiAuthorization(mock), mock
}
