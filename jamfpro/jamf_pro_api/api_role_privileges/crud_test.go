...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/api_role_privileges/mocks"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*ApiRolePrivileges, *mocks.APIRolePrivilegesMock) {
	t.Helper()
	mock := mocks.NewAPIRolePrivilegesMock()
	mock.RegisterMocks()
	return NewApiRolePrivileges(mock), mock
}
