...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/static_computer_groups/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*StaticComputerGroups, *mocks.StaticComputerGroupsMock) {
	t.Helper()
	mock := mocks.NewStaticComputerGroupsMock()
	return NewStaticComputerGroups(mock), mock
}
