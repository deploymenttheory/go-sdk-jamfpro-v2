...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/computer_prestages/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*ComputerPrestages, *mocks.ComputerPrestagesMock) {
	t.Helper()
	mock := mocks.NewComputerPrestagesMock()
	return NewComputerPrestages(mock), mock
}
