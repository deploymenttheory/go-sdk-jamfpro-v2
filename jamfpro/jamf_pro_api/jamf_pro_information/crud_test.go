...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/jamf_pro_information/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*JamfProInformation, *mocks.JamfProInformationMock) {
	t.Helper()
	mock := mocks.NewJamfProInformationMock()
	return NewJamfProInformation(mock), mock
}
