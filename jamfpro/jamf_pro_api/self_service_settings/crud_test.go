...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/self_service_settings/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*SelfServiceSettings, *mocks.SelfServiceSettingsMock) {
	t.Helper()
	mock := mocks.NewSelfServiceSettingsMock()
	return NewSelfServiceSettings(mock), mock
}
