...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/self_service_branding_macos/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*SelfServiceBrandingMacos, *mocks.SelfServiceBrandingMacOSMock) {
	t.Helper()
	mock := mocks.NewSelfServiceBrandingMacOSMock()
	return NewSelfServiceBrandingMacos(mock), mock
}
