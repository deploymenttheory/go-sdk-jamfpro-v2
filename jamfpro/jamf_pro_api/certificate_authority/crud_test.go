...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/certificate_authority/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*CertificateAuthority, *mocks.CertificateAuthorityMock) {
	t.Helper()
	mock := mocks.NewCertificateAuthorityMock()
	return NewCertificateAuthority(mock), mock
}
