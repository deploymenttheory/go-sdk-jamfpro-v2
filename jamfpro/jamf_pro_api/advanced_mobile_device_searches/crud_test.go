...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/advanced_mobile_device_searches/mocks"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*AdvancedMobileDeviceSearches, *mocks.AdvancedMobileDeviceSearchesMock) {
	t.Helper()
	mock := mocks.NewAdvancedMobileDeviceSearchesMock()
	mock.RegisterMocks()
	return NewAdvancedMobileDeviceSearches(mock), mock
}
