...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/volume_purchasing_subscriptions/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*VolumePurchasingSubscriptions, *mocks.VolumePurchasingSubscriptionsMock) {
	t.Helper()
	mock := mocks.NewVolumePurchasingSubscriptionsMock()
	return NewVolumePurchasingSubscriptions(mock), mock
}
