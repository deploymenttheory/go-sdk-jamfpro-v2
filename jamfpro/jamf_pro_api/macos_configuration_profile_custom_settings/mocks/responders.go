...
// MacOSConfigProfileCustomSettingsMock is a test double implementing interfaces.HTTPClient
...
func (m *MacOSConfigProfileCustomSettingsMock) RSQLBuilder() interfaces.RSQLFilterBuilder {
	return nil
}
