...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/ebooks/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*Ebooks, *mocks.EbooksMock) {
	t.Helper()
	mock := mocks.NewEbooksMock()
	return NewEbooks(mock), mock
}
