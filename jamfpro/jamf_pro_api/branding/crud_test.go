...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/branding/mocks"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*Branding, *mocks.BrandingMock) {
	t.Helper()
	mock := mocks.NewBrandingMock()
	mock.RegisterMocks()
	return NewBranding(mock), mock
}
