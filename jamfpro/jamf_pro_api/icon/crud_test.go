...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/icon/mocks"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*Icon, *mocks.IconsMock) {
	t.Helper()
	mock := mocks.NewIconsMock()
	mock.RegisterMocks()
	return NewIcon(mock), mock
}
