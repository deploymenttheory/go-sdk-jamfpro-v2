...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/smtp_server/mocks"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*SmtpServer, *mocks.SMTPServerMock) {
	t.Helper()
	mock := mocks.NewSMTPServerMock()
	mock.RegisterMocks()
	return NewSmtpServer(mock), mock
}
...
func setupMockServiceWithError(t *testing.T, registerFn func(*mocks.SMTPServerMock)) (*SmtpServer, *mocks.SMTPServerMock) {
	t.Helper()
	mock := mocks.NewSMTPServerMock()
	registerFn(mock)
	return NewSmtpServer(mock), mock
