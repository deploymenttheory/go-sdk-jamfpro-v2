...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/user/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*User, *mocks.UserMock) {
	t.Helper()
	mock := mocks.NewUserMock()
	return NewUser(mock), mock
}
