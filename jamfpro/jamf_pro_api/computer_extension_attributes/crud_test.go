...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/computer_extension_attributes/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*ComputerExtensionAttributes, *mocks.ComputerExtensionAttributesMock) {
	t.Helper()
	mock := mocks.NewComputerExtensionAttributesMock()
	return NewComputerExtensionAttributes(mock), mock
}
