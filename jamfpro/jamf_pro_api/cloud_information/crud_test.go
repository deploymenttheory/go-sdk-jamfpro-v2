...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/cloud_information/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*CloudInformation, *mocks.CloudInformationMock) {
	t.Helper()
	mock := mocks.NewCloudInformationMock()
	return NewCloudInformation(mock), mock
}
