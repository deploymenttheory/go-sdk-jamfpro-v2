...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/jamf_protect/mocks"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*JamfProtect, *mocks.JamfProtectMock) {
	t.Helper()
	mock := mocks.NewJamfProtectMock()
	mock.RegisterMocks()
	return NewJamfProtect(mock), mock
}
