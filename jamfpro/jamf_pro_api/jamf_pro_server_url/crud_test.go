...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/jamf_pro_server_url/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*JamfProServerUrl, *mocks.JamfProServerURLMock) {
	t.Helper()
	mock := mocks.NewJamfProServerURLMock()
	return NewJamfProServerUrl(mock), mock
}
