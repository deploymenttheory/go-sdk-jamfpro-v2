...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/api_integrations/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*ApiIntegrations, *mocks.ApiIntegrationsMock) {
	t.Helper()
	mock := mocks.NewApiIntegrationsMock()
	return NewApiIntegrations(mock), mock
}
