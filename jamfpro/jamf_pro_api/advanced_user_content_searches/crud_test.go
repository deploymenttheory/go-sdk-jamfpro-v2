...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/advanced_user_content_searches/mocks"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*AdvancedUserContentSearches, *mocks.AdvancedUserContentSearchesMock) {
	t.Helper()
	mock := mocks.NewAdvancedUserContentSearchesMock()
	mock.RegisterMocks()
	return NewAdvancedUserContentSearches(mock), mock
}
