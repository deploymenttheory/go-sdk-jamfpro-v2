...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/apns_client_push_status/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*ApnsClientPushStatus, *mocks.APNSClientPushStatusMock) {
	t.Helper()
	mock := mocks.NewAPNSClientPushStatusMock()
	return NewApnsClientPushStatus(mock), mock
}
