...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/devices/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*Devices, *mocks.DevicesMock) {
	t.Helper()
	mock := mocks.NewDevicesMock()
	return NewDevices(mock), mock
}
