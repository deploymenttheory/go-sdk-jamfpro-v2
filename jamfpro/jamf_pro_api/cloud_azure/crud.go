...
func NewCloudAzure(client interfaces.HTTPClient) *CloudAzure {
...
// Jamf Pro API docs: https://developer.jamf.com/jamf-pro/reference/get_v1-cloud-azure-id
func (s *CloudAzure) GetByIDV1(ctx context.Context, id string) (*ResourceCloudAzure, *resty.Response, error) {
	if id == "" {
...
func (s *CloudAzure) GetByNameV1(ctx context.Context, name string) (*ResourceCloudAzure, *resty.Response, error) {
	if name == "" {
...
// Jamf Pro API docs: https://developer.jamf.com/jamf-pro/reference/post_v1-cloud-azure
func (s *CloudAzure) CreateV1(ctx context.Context, request *ResourceCloudAzure) (*ResponseCloudAzureCreated, *resty.Response, error) {
	if request == nil {
...
// Jamf Pro API docs: https://developer.jamf.com/jamf-pro/reference/put_v1-cloud-azure-id
func (s *CloudAzure) UpdateByIDV1(ctx context.Context, id string, request *ResourceCloudAzure) (*ResourceCloudAzure, *resty.Response, error) {
	if id == "" {
		return nil, nil, fmt.Errorf("id is required")
	}
	if request == nil {
...
// UpdateByNameV1 updates the Azure Cloud IDP configuration by display name.
func (s *CloudAzure) UpdateByNameV1(ctx context.Context, name string, request *ResourceCloudAzure) (*ResourceCloudAzure, *resty.Response, error) {
	if name == "" {
		return nil, nil, fmt.Errorf("name is required")
	}
...
// Jamf Pro API docs: https://developer.jamf.com/jamf-pro/reference/delete_v1-cloud-azure-id
func (s *CloudAzure) DeleteByIDV1(ctx context.Context, id string) (*resty.Response, error) {
	if id == "" {
...
// DeleteByNameV1 deletes the Azure Cloud IDP configuration by display name.
func (s *CloudAzure) DeleteByNameV1(ctx context.Context, name string) (*resty.Response, error) {
	if name == "" {
