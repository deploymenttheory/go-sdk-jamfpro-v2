...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/jamf_pro_api/self_service_plus_settings/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*SelfServicePlusSettings, *mocks.SelfServicePlusSettingsMock) {
	t.Helper()
	mock := mocks.NewSelfServicePlusSettingsMock()
	return NewSelfServicePlusSettings(mock), mock
}
