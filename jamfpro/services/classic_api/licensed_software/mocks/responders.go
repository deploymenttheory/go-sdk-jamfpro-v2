...
// LicensedSoftwareMock is a test double implementing interfaces.HTTPClient for Classic API licensed software.
...
func (m *LicensedSoftwareMock) RegisterNotFoundErrorMock() {
	...
	m.responses["GET:/JSSResource/licensedsoftware/id/999"] = registeredResponse{
		statusCode: 404,
		rawBody:    body,
...
func (m *LicensedSoftwareMock) RegisterConflictErrorMock() {
	body := []byte("<br>An error has occurred.<br>Licensed software with that name already exists.<br><br>")
	m.responses["POST:/JSSResource/licensedsoftware/id/0"] = registeredResponse{
		statusCode: 409,
		rawBody:    body,
		errMsg:     "Jamf Pro Classic API error (409): Licensed software with that name already exists",
	}
}

// ---- interfaces.HTTPClient implementation ----

func (m *LicensedSoftwareMock) Get(ctx context.Context, path string, rsqlQuery map[string]string, _ map[string]string, result any) (*interfaces.Response, error) {
	_ = rsqlQuery
	return m.dispatch("GET", path, result)
}

func (m *LicensedSoftwareMock) Post(ctx context.Context, path string, _ any, _ map[string]string, result any) (*interfaces.Response, error) {
	return m.dispatch("POST", path, result)
}

func (m *LicensedSoftwareMock) PostWithQuery(ctx context.Context, path string, _ map[string]string, _ any, _ map[string]string, result any) (*interfaces.Response, error) {
	return m.dispatch("POST", path, result)
}

func (m *LicensedSoftwareMock) PostForm(ctx context.Context, path string, _ map[string]string, _ map[string]string, result any) (*interfaces.Response, error) {
	return m.dispatch("POST", path, result)
}

func (m *LicensedSoftwareMock) PostMultipart(ctx context.Context, path string, _ string, _ string, _ io.Reader, _ int64, _ map[string]string, _ map[string]string, _ interfaces.MultipartProgressCallback, result any) (*interfaces.Response, error) {
	return m.dispatch("POST", path, result)
}

func (m *LicensedSoftwareMock) Put(ctx context.Context, path string, _ any, _ map[string]string, result any) (*interfaces.Response, error) {
	return m.dispatch("PUT", path, result)
}

func (m *LicensedSoftwareMock) Patch(ctx context.Context, path string, _ any, _ map[string]string, result any) (*interfaces.Response, error) {
	return m.dispatch("PATCH", path, result)
}

func (m *LicensedSoftwareMock) Delete(ctx context.Context, path string, _ map[string]string, _ map[string]string, result any) (*interfaces.Response, error) {
	return m.dispatch("DELETE", path, result)
}

func (m *LicensedSoftwareMock) DeleteWithBody(ctx context.Context, path string, _ any, _ map[string]string, result any) (*interfaces.Response, error) {
	return m.dispatch("DELETE", path, result)
}

func (m *LicensedSoftwareMock) GetBytes(ctx context.Context, path string, rsqlQuery map[string]string, _ map[string]string) (*interfaces.Response, []byte, error) {
	_ = rsqlQuery
...
func (m *LicensedSoftwareMock) GetPaginated(ctx context.Context, path string, rsqlQuery map[string]string, _ map[string]string, mergePage func([]byte) error) (*interfaces.Response, error) {
	_ = rsqlQuery
	resp, err := m.dispatch("GET", path, nil)
	if err != nil {
		return resp, err
...
func (m *LicensedSoftwareMock) RSQLBuilder() interfaces.RSQLFilterBuilder { return nil }
...
func (m *LicensedSoftwareMock) dispatch(method, path string, result any) (*interfaces.Response, error) {
	...
	if !ok {
		...
		}, fmt.Errorf("LicensedSoftwareMock: no response registered for %s %s", method, path)
	}
