...
//
// Classic API docs: https://developer.jamf.com/jamf-pro/reference/findusergroupsbyid
func (s *Service) GetByID(ctx context.Context, id int) (*ResourceStaticUserGroup, *resty.Response, error) {
	if id <= 0 {
...
//
// Classic API docs: https://developer.jamf.com/jamf-pro/reference/findusergroupsbyname
func (s *Service) GetByName(ctx context.Context, name string) (*ResourceStaticUserGroup, *resty.Response, error) {
	if name == "" {
...
//
// Classic API docs: https://developer.jamf.com/jamf-pro/reference/createusergroupbyid
func (s *Service) Create(ctx context.Context, req *RequestStaticUserGroup) (*CreateUpdateResponse, *resty.Response, error) {
...
//
// Classic API docs: https://developer.jamf.com/jamf-pro/reference/updateusergroupbyid
func (s *Service) UpdateByID(ctx context.Context, id int, req *RequestStaticUserGroup) (*CreateUpdateResponse, *resty.Response, error) {
	if id <= 0 {
		return nil, nil, fmt.Errorf("user group ID must be a positive integer")
	}
	if err := ValidateRequest(req); err != nil {
...
//
// Classic API docs: https://developer.jamf.com/jamf-pro/reference/updateusergroupbyname
func (s *Service) UpdateByName(ctx context.Context, name string, req *RequestStaticUserGroup) (*CreateUpdateResponse, *resty.Response, error) {
	if name == "" {
		return nil, nil, fmt.Errorf("user group name is required")
	}
	if err := ValidateRequest(req); err != nil {
