...
func (s *Service) GetByID(ctx context.Context, id int) (*ResourceSoftwareUpdateServer, *resty.Response, error) {
	if id <= 0 {
...
func (s *Service) GetByName(ctx context.Context, name string) (*ResourceSoftwareUpdateServer, *resty.Response, error) {
	if name == "" {
...
func (s *Service) Create(ctx context.Context, req *RequestSoftwareUpdateServer) (*ResourceSoftwareUpdateServer, *resty.Response, error) {
	if req == nil {
...
func (s *Service) UpdateByID(ctx context.Context, id int, req *RequestSoftwareUpdateServer) (*ResourceSoftwareUpdateServer, *resty.Response, error) {
	if id <= 0 {
		return nil, nil, fmt.Errorf("software update server ID must be a positive integer")
	}
	if req == nil {
...
func (s *Service) UpdateByName(ctx context.Context, name string, req *RequestSoftwareUpdateServer) (*ResourceSoftwareUpdateServer, *resty.Response, error) {
	if name == "" {
		return nil, nil, fmt.Errorf("software update server name is required")
	}
	if req == nil {
