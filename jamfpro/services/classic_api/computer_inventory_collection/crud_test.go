...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/services/classic_api/computer_inventory_collection/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

// setupMockService creates a Service wired to a fresh ComputerInventoryCollectionMock.
func setupMockService(t *testing.T) (*computer_inventory_collection.Service, *mocks.ComputerInventoryCollectionMock) {
	t.Helper()
	mock := mocks.NewComputerInventoryCollectionMock()
	return computer_inventory_collection.NewService(mock), mock
}
