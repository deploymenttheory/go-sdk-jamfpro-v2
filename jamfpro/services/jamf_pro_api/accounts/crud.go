...
func (s *Service) GetByIDV1(ctx context.Context, id string) (*ResourceAccount, *resty.Response, error) {
	if id == "" {
...
func (s *Service) CreateV1(ctx context.Context, req *RequestAccount) (*CreateResponse, *resty.Response, error) {
	if req == nil {
