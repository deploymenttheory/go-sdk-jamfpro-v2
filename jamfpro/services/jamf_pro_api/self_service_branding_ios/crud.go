...
func (s *Service) GetByIDV1(ctx context.Context, id string) (*ResourceSelfServiceBrandingMobile, *resty.Response, error) {
	if id == "" {
...
// GetByNameV1 returns the specified self-service branding mobile configuration by name.
func (s *Service) GetByNameV1(ctx context.Context, name string) (*ResourceSelfServiceBrandingMobile, *resty.Response, error) {
	if name == "" {
...
func (s *Service) CreateV1(ctx context.Context, request *ResourceSelfServiceBrandingMobile) (*CreateResponse, *resty.Response, error) {
	if request == nil {
...
func (s *Service) UpdateByIDV1(ctx context.Context, id string, request *ResourceSelfServiceBrandingMobile) (*ResourceSelfServiceBrandingMobile, *resty.Response, error) {
	if id == "" {
...
// UpdateByNameV1 updates a self-service branding mobile configuration by name.
func (s *Service) UpdateByNameV1(ctx context.Context, name string, request *ResourceSelfServiceBrandingMobile) (*ResourceSelfServiceBrandingMobile, *resty.Response, error) {
