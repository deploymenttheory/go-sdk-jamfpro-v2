...
func (s *Service) CreateFromCSV(ctx context.Context, fileReader io.Reader, fileSize int64, fileName string) (CreateFromCSVResponse, *resty.Response, error) {
	if fileName == "" {
...
// CreateFromCSVFile opens the file at filePath and uploads it via CreateFromCSV.
func (s *Service) CreateFromCSVFile(ctx context.Context, filePath string) (CreateFromCSVResponse, *resty.Response, error) {
...
func (s *Service) GetCSVTemplate(ctx context.Context) ([]byte, *resty.Response, error) {
...
func (s *Service) ValidateCSV(ctx context.Context, fileReader io.Reader, fileSize int64, fileName string) (*CSVValidationSuccess, *resty.Response, error) {
	if fileName == "" {
		fileName = "inventory-preload.csv"
	}
	headers := map[string]string{
...
// ValidateCSVFile opens the file at filePath and validates it via ValidateCSV.
func (s *Service) ValidateCSVFile(ctx context.Context, filePath string) (*CSVValidationSuccess, *resty.Response, error) {
	f, err := os.Open(filePath)
	if err != nil {
		return nil, nil, fmt.Errorf("open CSV file: %w", err)
	}
...
func (s *Service) GetEAColumns(ctx context.Context) (*ExtensionAttributeColumnResult, *resty.Response, error) {
...
func (s *Service) Export(ctx context.Context, rsqlQuery map[string]string, req *ExportRequest, acceptType string) ([]byte, *resty.Response, error) {
...
func (s *Service) ListHistory(ctx context.Context, rsqlQuery map[string]string) (*HistoryListResponse, *resty.Response, error) {
...
func (s *Service) AddHistoryNote(ctx context.Context, req *AddHistoryNoteRequest) (*AddHistoryNoteResponse, *resty.Response, error) {
	if req == nil {
...
func (s *Service) ListRecords(ctx context.Context, rsqlQuery map[string]string) (*RecordListResponse, *resty.Response, error) {
...
func (s *Service) CreateRecord(ctx context.Context, record *InventoryPreloadRecord) (*CreateRecordResponse, *resty.Response, error) {
	if record == nil {
...
func (s *Service) DeleteAllRecords(ctx context.Context) (*resty.Response, error) {
...
func (s *Service) GetRecordByID(ctx context.Context, id string) (*InventoryPreloadRecord, *resty.Response, error) {
	if id == "" {
...
func (s *Service) UpdateRecord(ctx context.Context, id string, record *InventoryPreloadRecord) (*InventoryPreloadRecord, *resty.Response, error) {
	if id == "" {
		return nil, nil, fmt.Errorf("id is required")
	}
	if record == nil {
...
func (s *Service) DeleteRecord(ctx context.Context, id string) (*resty.Response, error) {
	if id == "" {
