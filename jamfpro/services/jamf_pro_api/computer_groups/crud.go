...
func (s *Service) ListSmartV2(ctx context.Context, rsqlQuery map[string]string) (*ListSmartResponse, *resty.Response, error) {
...
func (s *Service) GetSmartByIDV2(ctx context.Context, id string) (*ResourceSmartGroup, *resty.Response, error) {
	if id == "" {
...
func (s *Service) CreateSmartV2(ctx context.Context, request *RequestSmartGroup) (*CreateSmartResponse, *resty.Response, error) {
	if request == nil {
...
func (s *Service) UpdateSmartV2(ctx context.Context, id string, request *RequestSmartGroup) (*ResourceSmartGroup, *resty.Response, error) {
	if id == "" {
...
func (s *Service) DeleteSmartV2(ctx context.Context, id string) (*resty.Response, error) {
	if id == "" {
...
func (s *Service) ListStaticV2(ctx context.Context, rsqlQuery map[string]string) (*ListStaticResponse, *resty.Response, error) {
...
func (s *Service) GetStaticByIDV2(ctx context.Context, id string) (*ResourceStaticGroup, *resty.Response, error) {
	if id == "" {
...
func (s *Service) CreateStaticV2(ctx context.Context, request *RequestStaticGroup) (*CreateStaticResponse, *resty.Response, error) {
	if request == nil {
		return nil, nil, fmt.Errorf("request is required")
	}
...
func (s *Service) UpdateStaticByIDV2(ctx context.Context, id string, request *RequestStaticGroup) (*ResourceStaticGroup, *resty.Response, error) {
	if id == "" {
		return nil, nil, fmt.Errorf("id is required")
	}
...
func (s *Service) DeleteStaticByIDV2(ctx context.Context, id string) (*resty.Response, error) {
	if id == "" {
...
func (s *Service) ListAllV1(ctx context.Context) ([]ResourceGroupV1, *resty.Response, error) {
...
func (s *Service) GetSmartGroupMembershipByIDV2(ctx context.Context, id string) (*SmartGroupMembershipResponse, *resty.Response, error) {
	if id == "" {
		return nil, nil, fmt.Errorf("smart group ID is required")
	}
