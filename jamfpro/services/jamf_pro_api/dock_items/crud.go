...
func (s *Service) GetByIDV1(ctx context.Context, id string) (*ResourceDockItem, *resty.Response, error) {
	if id == "" {
...
func (s *Service) CreateV1(ctx context.Context, request *RequestDockItem) (*CreateResponse, *resty.Response, error) {
	if request == nil {
...
func (s *Service) UpdateByIDV1(ctx context.Context, id string, request *RequestDockItem) (*ResourceDockItem, *resty.Response, error) {
	if id == "" {
