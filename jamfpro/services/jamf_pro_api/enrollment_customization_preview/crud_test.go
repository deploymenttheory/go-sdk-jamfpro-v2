...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/services/jamf_pro_api/enrollment_customization_preview/mocks"
...
func setupMockService(t *testing.T) (*Service, *mocks.EnrollmentCustomizationPreviewMock) {
	t.Helper()
