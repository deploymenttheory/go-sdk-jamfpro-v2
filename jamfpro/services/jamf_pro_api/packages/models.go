...
// Create is step one; file upload is separate via UploadPackageV1.
...
// HistoryResponse is the response for GetPackageHistoryV1.
type HistoryResponse struct {
	TotalCount int             `json:"totalCount"`
	Results    []HistoryObject `json:"results"`
}

// AddHistoryNotesRequest is the body for AddPackageHistoryNotesV1.
