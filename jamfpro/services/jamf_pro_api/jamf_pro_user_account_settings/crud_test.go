...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/services/jamf_pro_api/jamf_pro_user_account_settings/mocks"
...
func setupMockService(t *testing.T) (*Service, *mocks.UserAccountSettingsMock) {
	t.Helper()
