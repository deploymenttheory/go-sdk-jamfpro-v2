...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/services/jamf_pro_api/mobile_device_enrollment_profile/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*Service, *mocks.MobileDeviceEnrollmentProfileMock) {
	t.Helper()
...
func TestUnit_MobileDeviceEnrollmentProfile_InterfaceCompliance(t *testing.T) {
	var _ MobileDeviceEnrollmentProfileServiceInterface = (*Service)(nil)
}
