...
get
https://yourServer.jamfcloud.com/api/v3/computers-inventory-detail/{id}
...
200
Details of computer were found
...
curl --request GET \
     --url https://yourserver.jamfcloud.com/api/v3/computers-inventory-detail/ \
     --header 'accept: application/json'
...
get
https://yourServer.jamfcloud.com/api/v3/computers-inventory/filevault
...
curl --request GET \
     --url 'https://yourserver.jamfcloud.com/api/v3/computers-inventory/filevault?page=0&page-size=100' \
     --header 'accept: application/json'
  ...
  "results": [
    {
      "computerId": "1",
      "name": "Boalime",
      "personalRecoveryKey": "Z4A6-ONF8-KUHD-AVTG-C3ER-6A8G",
      "bootPartitionEncryptionDetails": {
        "partitionName": "main",
        "partitionFileVault2State": "ENCRYPTING",
        "partitionFileVault2Percent": 100
