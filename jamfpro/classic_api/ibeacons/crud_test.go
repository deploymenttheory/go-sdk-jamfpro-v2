...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/classic_api/ibeacons/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

// setupMockService creates a Service wired to a fresh IBeaconsMock.
func setupMockService(t *testing.T) (*Ibeacons, *mocks.IBeaconsMock) {
	t.Helper()
	mock := mocks.NewIBeaconsMock()
	return NewIbeacons(mock), mock
}
...
func TestUnit_Ibeacons_GetByName_Success(t *testing.T) {
	...
	result, resp, err := svc.GetByName(context.Background(), "Lobby Beacon")
	require.NoError(t, err)
	require.NotNil(t, result)
	require.NotNil(t, resp)
...
func TestUnit_Ibeacons_UpdateByName_Success(t *testing.T) {
	...
	result, resp, err := svc.UpdateByName(context.Background(), "Lobby Beacon", req)
	require.NoError(t, err)
	require.NotNil(t, result)
	require.NotNil(t, resp)
...
func TestUnit_Ibeacons_DeleteByName_Success(t *testing.T) {
	...
	resp, err := svc.DeleteByName(context.Background(), "Lobby Beacon")
	require.NoError(t, err)
	require.NotNil(t, resp)
	assert.Equal(t, 200, resp.StatusCode())
}
