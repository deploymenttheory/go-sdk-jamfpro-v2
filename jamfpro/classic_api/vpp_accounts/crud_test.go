...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/classic_api/vpp_accounts/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*VppAccounts, *mocks.VPPAccountsMock) {
	t.Helper()
	mock := mocks.NewVPPAccountsMock()
	return NewVppAccounts(mock), mock
}
