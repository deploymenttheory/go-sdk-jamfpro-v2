...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/classic_api/disk_encryption_configurations/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*DiskEncryptionConfigurations, *mocks.DiskEncryptionConfigurationsMock) {
	t.Helper()
	mock := mocks.NewDiskEncryptionConfigurationsMock()
	return NewDiskEncryptionConfigurations(mock), mock
}
