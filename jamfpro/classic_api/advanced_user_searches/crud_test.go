...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/classic_api/advanced_user_searches/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

// setupMockService creates a Service wired to a fresh AdvancedUserSearchesMock.
func setupMockService(t *testing.T) (*AdvancedUserSearches, *mocks.AdvancedUserSearchesMock) {
	t.Helper()
	mock := mocks.NewAdvancedUserSearchesMock()
	return NewAdvancedUserSearches(mock), mock
}
