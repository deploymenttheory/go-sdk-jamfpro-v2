...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/classic_api/directory_bindings/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*DirectoryBindings, *mocks.DirectoryBindingsMock) {
	t.Helper()
	mock := mocks.NewDirectoryBindingsMock()
	return NewDirectoryBindings(mock), mock
}
