...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/classic_api/printers/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

// setupMockService creates a Service wired to a fresh PrintersMock.
func setupMockService(t *testing.T) (*Printers, *mocks.PrintersMock) {
	t.Helper()
	mock := mocks.NewPrintersMock()
	return NewPrinters(mock), mock
}
