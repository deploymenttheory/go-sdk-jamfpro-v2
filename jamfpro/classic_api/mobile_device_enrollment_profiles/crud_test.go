...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/classic_api/mobile_device_enrollment_profiles/mocks"
...
func TestUnit_MobileDeviceEnrollmentProfiles_List(t *testing.T) {
	...
	svc := mobile_device_enrollment_profiles.NewMobileDeviceEnrollmentProfiles(mockClient)
