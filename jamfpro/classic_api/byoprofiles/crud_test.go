...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/classic_api/byoprofiles/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

// setupMockService creates a Service wired to a fresh BYOProfilesMock.
func setupMockService(t *testing.T) (*Byoprofiles, *mocks.BYOProfilesMock) {
	t.Helper()
	mock := mocks.NewBYOProfilesMock()
	return NewByoprofiles(mock), mock
}
