...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/classic_api/webhooks/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

// setupMockService creates a Service wired to a fresh WebhooksMock.
func setupMockService(t *testing.T) (*Webhooks, *mocks.WebhooksMock) {
	t.Helper()
	mock := mocks.NewWebhooksMock()
	return NewWebhooks(mock), mock
}
