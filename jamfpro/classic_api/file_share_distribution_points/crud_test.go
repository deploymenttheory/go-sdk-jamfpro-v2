...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/classic_api/file_share_distribution_points/mocks"
...
func TestUnit_FileShareDistributionPoints_List(t *testing.T) {
	...
	svc := file_share_distribution_points.NewFileShareDistributionPoints(mockClient)
