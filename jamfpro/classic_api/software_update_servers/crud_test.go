...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/classic_api/software_update_servers/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

func setupMockService(t *testing.T) (*SoftwareUpdateServers, *mocks.SoftwareUpdateServersMock) {
	t.Helper()
	mock := mocks.NewSoftwareUpdateServersMock()
	return NewSoftwareUpdateServers(mock), mock
}
