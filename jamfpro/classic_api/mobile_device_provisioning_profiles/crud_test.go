...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/classic_api/mobile_device_provisioning_profiles/mocks"
...
func TestUnit_MobileDeviceProvisioningProfiles_List(t *testing.T) {
	...
	svc := mobile_device_provisioning_profiles.NewMobileDeviceProvisioningProfiles(mockClient)
