...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/classic_api/policies/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

// setupMockService creates a Service wired to a fresh PoliciesMock.
func setupMockService(t *testing.T) (*Policies, *mocks.PoliciesMock) {
	t.Helper()
	mock := mocks.NewPoliciesMock()
	return NewPolicies(mock), mock
}
