...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/classic_api/advanced_computer_searches/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

// setupMockService creates a Service wired to a fresh AdvancedComputerSearchesMock.
func setupMockService(t *testing.T) (*AdvancedComputerSearches, *mocks.AdvancedComputerSearchesMock) {
	t.Helper()
	mock := mocks.NewAdvancedComputerSearchesMock()
	return NewAdvancedComputerSearches(mock), mock
}
