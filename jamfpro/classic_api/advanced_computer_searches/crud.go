...
func NewAdvancedComputerSearches(client interfaces.HTTPClient) *AdvancedComputerSearches {
...
func (s *AdvancedComputerSearches) List(ctx context.Context) (*ListResponse, *resty.Response, error) {
...
func (s *AdvancedComputerSearches) GetByID(ctx context.Context, id int) (*ResourceAdvancedComputerSearch, *resty.Response, error) {
	if id <= 0 {
...
func (s *AdvancedComputerSearches) GetByName(ctx context.Context, name string) (*ResourceAdvancedComputerSearch, *resty.Response, error) {
	if name == "" {
...
func (s *AdvancedComputerSearches) Create(ctx context.Context, req *RequestAdvancedComputerSearch) (*CreateUpdateResponse, *resty.Response, error) {
	if req == nil {
...
func (s *AdvancedComputerSearches) UpdateByID(ctx context.Context, id int, req *RequestAdvancedComputerSearch) (*CreateUpdateResponse, *resty.Response, error) {
	if id <= 0 {
		return nil, nil, fmt.Errorf("advanced computer search ID must be a positive integer")
	}
	if req == nil {
...
func (s *AdvancedComputerSearches) UpdateByName(ctx context.Context, name string, req *RequestAdvancedComputerSearch) (*CreateUpdateResponse, *resty.Response, error) {
	if name == "" {
		return nil, nil, fmt.Errorf("advanced computer search name is required")
	}
	if req == nil {
...
func (s *AdvancedComputerSearches) DeleteByID(ctx context.Context, id int) (*resty.Response, error) {
	if id <= 0 {
...
func (s *AdvancedComputerSearches) DeleteByName(ctx context.Context, name string) (*resty.Response, error) {
	if name == "" {
