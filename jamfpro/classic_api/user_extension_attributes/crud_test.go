...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/classic_api/user_extension_attributes/mocks"
...
func TestUnit_UserExtensionAttributes_List(t *testing.T) {
	...
	svc := user_extension_attributes.NewUserExtensionAttributes(mockClient)
