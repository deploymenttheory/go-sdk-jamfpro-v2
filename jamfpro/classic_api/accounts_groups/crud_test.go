...
import (
	...
	"github.com/deploymenttheory/go-sdk-jamfpro-v2/jamfpro/classic_api/accounts_groups/mocks"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/require"
)

// setupMockService creates a Service wired to a fresh AccountGroupsMock.
func setupMockService(t *testing.T) (*AccountsGroups, *mocks.AccountGroupsMock) {
	t.Helper()
	mock := mocks.NewAccountGroupsMock()
	return NewAccountsGroups(mock), mock
}
