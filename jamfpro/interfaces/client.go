...
type RSQLFilterBuilder interface {
	...
	// Build returns the completed RSQL filter string ready to use as queryParams["filter"].
	Build() string
...
type HTTPClient interface {
	...
	// Pass the Build() result as queryParams["filter"] to filter paginated results.
